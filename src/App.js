    ...
    return (
      <div>
        ...
        <Routes>
          ...
          <Route exact path="/sports" element={<News key = "sportts" pageSize={8} country="in" category="sports"/>} />
          <Route exact path="/technology" element={<News key = "techmology" pageSize={8} country="in" category="technology"/>} />
        </Routes>  
        </Router>
      </div>
    )
